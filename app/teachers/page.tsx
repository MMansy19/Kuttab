...
import { FaFilter, FaSearch, FaSortAmountDown, FaBook, FaStar, FaUserGraduate, FaQuran } from 'react-icons/fa';
          ...
          <div className="max-w-6xl mx-auto">
            <div className="flex flex-col lg:flex-row items-center justify-between">
              <div className="text-center lg:text-right mb-8 lg:mb-0 lg:max-w-2xl">
                <h1 className="text-3xl md:text-5xl font-bold mb-4" dir="rtl">معلمو القرآن المميزون</h1>
                ...
                <div className="mt-6 flex flex-wrap gap-4 justify-center lg:justify-end">
                  {heroStats.map((stat, index) => (
                    <div key={index} className="flex items-center bg-white/20 backdrop-blur-sm py-2 px-4 rounded-full gap-1">
                      {stat.icon}
